...
public class PlacesMainActivity extends AppCompatActivity {
    ...
    private PlacesMainActivity mCurrentActivity;
    ...
    * */
    ...
    private synchronized void fetchNearByPlaces() {
       ...
       // Dialogs.INSTANCE.showLoader(mCurrentActivity);
        ...
        mPlacesRepository.getNearbyPlaces(mPlacesDataHandler, AppPreferences.getLatitude(PlacesMainActivity.this)+","+AppPreferences.getLongitude(PlacesMainActivity.this), mNextPageToken);
